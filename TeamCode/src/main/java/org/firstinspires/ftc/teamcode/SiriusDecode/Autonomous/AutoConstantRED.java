...
public class AutoConstantRED {
    ...
    public static SparkFunOTOS.Pose2D
            FarStripBallsGoal = new SparkFunOTOS.Pose2D(1370,689,Math.toRadians(-90)),
            HumanPlayerBalls = new SparkFunOTOS.Pose2D(1420,0,Math.toRadians(-90))
    ;

    public static SparkFunOTOS.Pose2D shootingFarInstant = new SparkFunOTOS.Pose2D(230,101,Math.toRadians(-42));
    public static SparkFunOTOS.Pose2D GoalPositionFar = new SparkFunOTOS.Pose2D(1355,3150,0);
    ...
    public static ArrayList<PurePersuit.Point> GoingFromShootToHuman = new ArrayList<>(Arrays.asList(
            new PurePersuit.Point(shootingFarInstant.x,shootingFarInstant.y, Math.toDegrees(-68) ,0.2),
            new PurePersuit.Point(633, 0, Math.toRadians(-105), 0.2),
    ...
    public static ArrayList<PurePersuit.Point> GoingFromHumanToShoot = new ArrayList<>(Arrays.asList(
            new PurePersuit.Point(HumanPlayerBalls.x, HumanPlayerBalls.y, HumanPlayerBalls.h, 0.2),
            new PurePersuit.Point(423, 20,HumanPlayerBalls.h , 0.2)
    ));
    ...
    public static ArrayList<PurePersuit.Point> GoingFromShootToGatherBalls = new ArrayList<>(Arrays.asList(
            ...
            new PurePersuit.Point(HumanPlayerBalls.x, HumanPlayerBalls.y, HumanPlayerBalls.h+Math.toRadians(20), 0.5),
            new PurePersuit.Point(1300, 1050,Math.toRadians(-37), 0.4)
            ));
    ...
    public static SparkFunOTOS.Pose2D CloseStripBallsToGoalCloseStart = new SparkFunOTOS.Pose2D(-600,1200,Math.toRadians(90)),
            MiddleStripBallsGoalCloseStart = new SparkFunOTOS.Pose2D(-790,1890,Math.toRadians(90)),
            GateClose = new SparkFunOTOS.Pose2D(-630,1840,Math.toRadians(90)),

            GateCloseWait = new SparkFunOTOS.Pose2D(-750,1940,Math.toRadians(123));

    public static SparkFunOTOS.Pose2D shootingClose = new SparkFunOTOS.Pose2D(526,1554,Math.toRadians(73));
    public static SparkFunOTOS.Pose2D shootingCloseInstant = new SparkFunOTOS.Pose2D(452,1440,Math.toRadians(-53));
    ...
    public static ArrayList<PurePersuit.Point> GoingFromShootToGate = new ArrayList<>(Arrays.asList(
            ...
            new PurePersuit.Point(-194, 1700, GateClose.h,0.2),
    ...
    public static ArrayList<PurePersuit.Point> GoingFromGateToShoot = new ArrayList<>(Arrays.asList(
            ...
            new PurePersuit.Point(-60, 1700, MiddleStripBallsGoalCloseStart.h, 0.2),
